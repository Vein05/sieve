...
from evidence.requirements import build_query_evidence_plan
from evidence.renderer import display_slot_text
...
from evidence.roles import infer_unit_roles
from evidence.units import EvidenceUnit, build_evidence_units_for_views
from evidence.projection import project_evidence_candidates, unresolved_slots
from .modeling.features import _answer_shape_signals
from retrieval.query_targets import QueryTargets, extract_query_targets
from .execution.selection import compile_evidence
