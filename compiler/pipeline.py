...
from shared.nlp import CandidateView, shared_result
from .evidence_compiler import compile_evidence
from .evidence_planner import plan_evidence
from evidence.renderer import render_evidence_package, render_multi_session_fact_list
from retrieval.proposals import retrieve_proposal
...
def _resolve_proxy_runtime_labels(
    *,
    ...
    if not use_proxy_runtime_labels:
        return {}
    try:
        from .modeling_entry import resolve_memory_usefulness_labels
...
def run_sieve_pipeline(row: dict[str, Any], context: dict[str, Any]) -> dict[str, Any]:
    ...
    from retrieval.proposals import _cache_key as _proposal_cache_key
