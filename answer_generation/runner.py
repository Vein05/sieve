...
from answer_generation.prompting import _COMPACT_READER_VARIANTS, build_answer_generation_prompt
from answer_generation.scoring import evaluate_run, harmful_use_flags, quality_metrics, quality_metrics_for_row
from assembly_methods.llm_compiler import llm_compile, format_llm_evidence
from answer_generation.selector_registry import (
    SYSTEMS,
    SYSTEM_NOTES,
...
from controller_v0.logic import token_count
...
def _run_phase1_step(
    *,
    ...
    if _clean in ("", "unknown", "unknown.") and selected_memory_texts and str(system).strip().lower() in ("sieve", "bm25_sieve"):
        try:
            from assembly_methods.compiler.adapters.minilm_qa_adapter import extract_span as _minilm_extract
