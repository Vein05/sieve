...
from controller_v0.constants import DATE_RE, NEGATION_PATTERNS, TEMPORAL_HINTS, TIME_RE, UPDATE_MARKERS
from controller_v0.logic import token_count
from controller_v0.text_utils import normalize_text

from .common import CandidateView, cached_build_profile, cached_sent_tokenize, cached_word_tokenize, cached_pos_tag
from .memory_object_builder import (
...
def build_evidence_units_for_views(
    ...
    """
    from .perf_counters import get_counters
    _pc = get_counters()
